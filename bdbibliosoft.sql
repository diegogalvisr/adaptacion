...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2023 a las 14:56:52
...
(23001, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'JUAN DIEGO', 'GALVIS ROMERO', 'CALLE 22A#21-19', 1, 'img/diego.jpg'),
(23002, 'aux', '21232f297a57a5a743894a0e4a801fc3', 'YORGEN ELIECER', 'GALVIS ROMERO ', 'CALLE 22A#21-19', 2, NULL),
...
INSERT INTO `intento_login` (`id_admin`, `tiempo`) VALUES
(23001, '1955558'),
(23002, '1698856446'),
(23002, '1698890997'),
(23002, '1698891009'),
...
(24003, 184811, 'HOLA PUES', 2, 1, 'c', 5899, 'Materiales', 2, 3, 2);
...
(25001, 'A', 23001, 26004, 24003, 2, '2023-10-23', '2023-10-30', 1, 1),
(25002, 'A', 23001, 26007, 24003, 2, '2023-10-25', '2023-11-01', 1, 1);
...
(26007, '20238592', 'JHON', 'MONSALVE', 'UNISIMON', '32141', '10654585', 7, NULL),
(26008, '20235787', 'DIEGO', 'GALVIS', 'CLL555', '3192', '32659', 3, NULL);
...
--
ALTER TABLE `prestamos`
  MODIFY `id_prestamo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25003;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26009;
